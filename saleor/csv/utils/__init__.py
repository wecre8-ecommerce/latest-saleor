class ProductExportFields:
    ...
    PRODUCT_ATTRIBUTE_FIELDS = {
        ...
        "slug": "product_type__product_attributes__slug",
        "input_type": "product_type__product_attributes__input_type",
        "entity_type": "product_type__product_attributes__entity_type",
        "unit": "product_type__product_attributes__unit",
        "attribute_pk": "product_type__product_attributes__pk",
